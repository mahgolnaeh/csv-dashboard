...
def generate_charts(
    ...
    most informative charts:
        ...
        P6  R04         — numeric x categorical (low-cardinality cats, top-N numerics)
    ...
    # ── P6: Best numeric x categorical pairs (R04) ────────────────────
    # Restricted to useful (low-cardinality) categoricals x top-N numerics.
    ...
    # R04 pool: high-cardinality categoricals x all numerics
